...
C     respect to parameters at phases of observations
      ...
      DIMENSION VH(13),LV(13),PSJ(300),FL1(41),SP(300),VCLC(300),VMX(5)
      DIMENSION HARO(41),HARP(41),BFRY(41),BFRYD(164),VRY(41),HARQ(41)
      DIMENSION HARA(41), HARC(41),HARD(41),HARE(41),HARF(41),HARG(41),
     $HARH(41),HARI(41),HARJ(41),HARK(41),HARL(41),HARM(41),HARN(41)
     ...
     $DLDTZSA(300),DLDECCA(300),DLDOMA(300),VLPSI(300)
      DIMENSION XRY01(41),XRY02(41),XRY03(41),XRY04(41),XRY05(41),
     $XRY06(41),XRY07(41),XRY08(41),XRY09(41),XRY10(41),XRY11(41),
     $XRY12(41),HARR(41)
      DIMENSION ARR011(164),ARR012(164),ARR013(164),ARR014(164),
     $ARR015(164),
     $ARR016(164),ARR017(164),ARR018(164),ARR019(164),ARR0110(164),
     $ARR0111(164),ARR0115(164),ARR0116(164),ARR0117(164),ARR0118(164),
     $ARR0119(164),ARR0120(164),ARR0121(164),ARR0122(164),ARR0123(164),
     $ARR0124(164),ARR0135(164),ARR0136(164),ARR0137(164),ARR0138(164),
     $ARR0112(164),ARR0113(164),ARR0114(164),ARR021(164),ARR022(164),
     $ARR023(164),ARR024(164)
      DIMENSION NWLV(5)
...
C**********************************************************************
C
      OPEN ( UNIT= 12,   FILE='C:\LGTSYN\PEDCS\PEDCS.ILS',STATUS='OLD')
...
C**********************************************************************
  ...
  106 FORMAT (10I5)
  108 FORMAT (2E20.7)
  205 FORMAT (1X,'PEDCS',5X,'Program running time=',F14.4,2X,'minutes')
...
C     COMPLETE PHASE,PRI.MIN.,INGRESS 
  623 KL=ND12-1
      ...
      GO TO 322
  631 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     ...
     $DLDTZS)
      GO TO 322
  633 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY2A
     ...
     $DLDTZS)
      GO TO 322
  635 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY3A
     ...
     $DLDTZS)
      GO TO 322   
  637 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY4A
     ...
     $DLDTZS)
      GO TO 322
  639 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY5A
     ...
     $DLDTZS)
      GO TO 322   
  641 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY6A
     ...
     $DLDTZS)
      GO TO 322
  643 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY7A
     ...
     $DLDTZS)
      GO TO 322
  645 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY8A
     ...
     $DLDTZS)
      GO TO 322
  647 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY9A
     ...
     $DLDTZS)
      GO TO 322
  649 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY10A
     ...
     $DLDTZS)
      GO TO 322   
  651 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY11A
     ...
     $DLDTZS)
      GO TO 322
  653 CALL FLDFA(NRY,KST,HARA,HARC,HARD,HARE,
     $HARF,HARG,HARH,HARI,HARJ,HARK,HARL,HARM,HARN,HARO,HARP,HARQ,HARR)
      IF (NRY.LT.2) GO TO 655
      KYVA=KY12A
